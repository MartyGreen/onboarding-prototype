...
const tableFieldsPreset = {
  ...
  'girbo_financial_result_simple': [
    { name: 'id', type: 'NUMBER', description: '', inTable: true },
    { name: 'okud', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'revenue_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'revenue_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'revenue_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'normal_operation_costs_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'normal_operation_costs_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'normal_operation_costs_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'accrued_interest_expense_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'accrued_interest_expense_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'accrued_interest_expense_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'other_income_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'other_income_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'other_income_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'other_expense_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'other_expense_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'other_expense_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'income_tax_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'income_tax_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'income_tax_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'net_profit_loss_num', type: 'VARCHAR2', description: '', inTable: true },
    { name: 'net_profit_loss_fiscal_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'net_profit_loss_prev_year', type: 'NUMBER', description: '', inTable: true },
    { name: 'mt_change_date', type: 'DATE', description: '', inTable: true },
  ],
};
...
const tableTagsPreset = {
  'screpka_orders_company': ['Скрепка', 'Заказы', 'Компании', 'E-Commerce', 'DWH', 'Чат', 'Bennu', 'Общение с клиентами', 'Коммуникации'],
  'girbo_financial_result_simple': ['ГИРБО', 'Финансы', 'Отчётность', 'Бухгалтерия', 'DWH', 'Чат', 'Bennu', 'Общение с клиентами', 'Коммуникации'],
};
...
const aiFieldDescriptions = {
  ...
  // girbo_financial_result_simple
  'okud': 'Код формы по ОКУД',
  'revenue_num': 'Номер пояснения к строке выручки',
  'revenue_fiscal_year': 'Выручка за отчётный год',
  'revenue_prev_year': 'Выручка за предыдущий год',
  'normal_operation_costs_num': 'Номер пояснения к строке себестоимости',
  'normal_operation_costs_fiscal_year': 'Себестоимость за отчётный год',
  'normal_operation_costs_prev_year': 'Себестоимость за предыдущий год',
  'accrued_interest_expense_num': 'Номер пояснения к строке процентных расходов',
  'accrued_interest_expense_fiscal_year': 'Проценты к уплате за отчётный год',
  'accrued_interest_expense_prev_year': 'Проценты к уплате за предыдущий год',
  'other_income_num': 'Номер пояснения к строке прочих доходов',
  'other_income_fiscal_year': 'Прочие доходы за отчётный год',
  'other_income_prev_year': 'Прочие доходы за предыдущий год',
  'other_expense_num': 'Номер пояснения к строке прочих расходов',
  'other_expense_fiscal_year': 'Прочие расходы за отчётный год',
  'other_expense_prev_year': 'Прочие расходы за предыдущий год',
  'income_tax_num': 'Номер пояснения к строке налога на прибыль',
  'income_tax_fiscal_year': 'Налог на прибыль за отчётный год',
  'income_tax_prev_year': 'Налог на прибыль за предыдущий год',
  'net_profit_loss_num': 'Номер пояснения к строке чистой прибыли/убытка',
  'net_profit_loss_fiscal_year': 'Чистая прибыль (убыток) за отчётный год',
  'net_profit_loss_prev_year': 'Чистая прибыль (убыток) за предыдущий год',
};
...
export default function NewDocumentPage() {
  ...
  return (
    <div className="flex-1 flex overflow-hidden h-full min-h-0">
      ...
      <div className="flex-1 flex flex-col px-8 overflow-y-auto min-h-0 hide-scrollbar" style={{ paddingTop: 27 }}>
